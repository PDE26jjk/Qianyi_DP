...
struct Statistics
{
    double flipCheckTime;   // Time for checking flip candidates
    double flipExecTime;    // Time for executing flips
    double flipUpdateOppTime; // Time for updating opposite edges
    int flipLoopCount;      // Number of flip loop iterations
    double initTime;
    double splitTime;
    double flipTime;
    double relocateTime;
