...
static __device__ __forceinline__ void atomicAddMat3(Mat3* addr, const Mat3 val) {
    atomicAdd(&(addr->r[0].x), val.r[0].x);
    atomicAdd(&(addr->r[0].y), val.r[0].y);
    atomicAdd(&(addr->r[0].z), val.r[0].z);
    atomicAdd(&(addr->r[1].x), val.r[1].x);
    atomicAdd(&(addr->r[1].y), val.r[1].y);
    atomicAdd(&(addr->r[1].z), val.r[1].z);
    atomicAdd(&(addr->r[2].x), val.r[2].x);
    atomicAdd(&(addr->r[2].y), val.r[2].y);
    atomicAdd(&(addr->r[2].z), val.r[2].z);
}
