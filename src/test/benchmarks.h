...
std::vector<int> bvh_benchmark(const std::vector<float>& vertices_in, const std::vector<int>& faces_in,  const std::vector<float>& query_points,int warmup, int runs, bool verify);
