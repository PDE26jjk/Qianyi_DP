...
public:
	...
	// Cub temporary storage needed by the heaviest primitive used by the
	// pipeline for `maxItems` elements. Callers should allocate this instead of
	// hard-coding a size (the demo used to reserve ~940 MB unconditionally).
	static size_t cubTempBytes(int maxItems);
